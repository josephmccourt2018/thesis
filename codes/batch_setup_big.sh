...
do
    ...
    gmx genconf -nbox 2 2 1 -f bilayer_centered.gro -o bilayer_big.gro
    
    sed -i '$d' topol.top
    sed -i '$d' topol.top
    
    gmx solvate -cp bilayer_big.gro -p topol.top -o solvated.gro
    ...
    #######################################################################
    echo Did you fix topology file for total waters and residues? Enter y when ready
    read ready
    echo $ready
    ...
    #gmx grompp -f minim.mdp -c solvated_fixed.gro -p topol.top -o em.tpr
    gmx mdrun -deffnm em
 
    gmx make_ndx -f em.gro -o index.ndx

    cp ../../0/big/submit_b1030.sh .
