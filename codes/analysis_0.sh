...
EOF
    ...
    echo "15" | gmx density -f ../combined.xtc -s ../md_semi.tpr -n dens_groups.ndx -o dens_head.xvg -sl 100
    echo "16" | gmx density -f ../combined.xtc -s ../md_semi.tpr -n dens_groups.ndx -o dens_tails.xvg -sl 100
