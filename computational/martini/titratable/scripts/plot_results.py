...
parser.add_argument('-f', dest='file', type=str, default='results_long_8fs.txt', help='results file (.txt)')
parser.add_argument('-o', dest='out', type=str, default='results_long_8fs.pdf', help='output file (.pdf)')
